...
class WarmupTests(unittest.TestCase):
    ...
    def test_get_packages(self):
        ...
        Return: 
            None
        """
        req_packages = ['matplotlib', 'numpy', 'tqdm', 
                        'imageio', 'scikit-learn', 'notebook', 
                        'statsmodels', 'jupyterlab', 'scikit-image', 
                        'pandas', 'ipywidgets', 'seaborn', 'tweet-preprocessor']
        ...
        self.assertTrue(len(missing_packages) == 0, msg=f"Missing: {missing_packages}") 
    ...
    def test_indices_of_k(self):
        ...
        self.assertTrue(student.shape == solution.shape, msg="Check shapes")
    ...
    def test_sum_squares(self):
        ...
        if student.shape != solution.shape:
            print(f'sum_squares output shape: \n expected: {solution.shape}\n actual: {student.shape}')
        self.assertTrue((solution == student).all())
